...
function Movie_card({
  ...
  return (
    <div
      className="   bg-center bg-no-repeat bg-cover w-[180px] h-[40vh] rounded-2xl  ml-1 mb-4   flex  flex-col   items-end justify-between  font-black border-2 border-gray-600 hover:scale-110 hover:border-white duration-300  bg-gray-800/60"
      style={{
